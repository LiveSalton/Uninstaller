...
import 'package:flutter_healme/heal/routers/web_page_transitions.dart';
...
class ThemeProvider extends ChangeNotifier {
  ...
  void syncTheme() {
    ...
    if (theme != null && theme.isNotEmpty && theme != ThemeMode.system.value) {
      notifyListeners();
    }
  }

  void setTheme(ThemeMode themeMode) {
    MMKVHelper.putString(Constant.theme, themeMode.value);
    notifyListeners();
  }
  ...
  ThemeData getTheme({bool isDarkMode = false}) {
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        ...
        systemOverlayStyle: isDarkMode ? ThemeUtils.light : ThemeUtils.light,
      ),
