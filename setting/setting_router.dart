...
import 'package:flutter_healme/heal/routers/i_router.dart';
import 'package:flutter_healme/setting/page/locale_page.dart';
import 'package:flutter_healme/setting/page/theme_page.dart';
...
class SettingRouter implements IRouterProvider{
  ...
  static String reportPage = '/setting/report';
  ...
  void initRouter(FluroRouter router) {
    ...
    router.define(reportPage, handler: Handler(handlerFunc: (_, __) => const ReportPage()));
  }
