...
class t {
    static final int[] a = {R.attr.targetClass, R.attr.targetId, R.attr.excludeId, R.attr.excludeClass, R.attr.targetName, R.attr.excludeName};
    static final int[] b = {R.attr.fromScene, R.attr.toScene, R.attr.transition};
