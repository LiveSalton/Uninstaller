...
public class g implements Interpolator {
    ...
    public g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray a = androidx.core.content.a.g.a(resources, theme, attributeSet, a.l);
        a(a, xmlPullParser);
        a.recycle();
    }
    ...
    private void a(TypedArray typedArray, XmlPullParser xmlPullParser) {
        if (androidx.core.content.a.g.a(xmlPullParser, "pathData")) {
            String a = androidx.core.content.a.g.a(typedArray, xmlPullParser, "pathData", 4);
            Path a2 = androidx.core.graphics.c.a(a);
            if (a2 == null) {
        ...
        float a3 = androidx.core.content.a.g.a(typedArray, xmlPullParser, "controlX1", 0, 0.0f);
        float a4 = androidx.core.content.a.g.a(typedArray, xmlPullParser, "controlY1", 1, 0.0f);
        boolean a5 = androidx.core.content.a.g.a(xmlPullParser, "controlX2");
        if (a5 != androidx.core.content.a.g.a(xmlPullParser, "controlY2")) {
            throw new InflateException("pathInterpolator requires both controlX2 and controlY2 for cubic Beziers.");
        }
        if (!a5) {
            a(a3, a4);
        } else {
            a(a3, a4, androidx.core.content.a.g.a(typedArray, xmlPullParser, "controlX2", 2, 0.0f), androidx.core.content.a.g.a(typedArray, xmlPullParser, "controlY2", 3, 0.0f));
        }
    }
