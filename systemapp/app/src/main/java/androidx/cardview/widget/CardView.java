...
public class CardView extends FrameLayout {
    ...
    public CardView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, a.C0014a.cardViewStyle);
    }
    ...
    public CardView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.i = new d() { // from class: androidx.cardview.widget.CardView.1
            ...
            public void a(int i2, int i3, int i4, int i5) {
                ...
                CardView.super.setPadding(i2 + CardView.this.c.left, i3 + CardView.this.c.top, i4 + CardView.this.c.right, i5 + CardView.this.c.bottom);
            }
        ...
        this.a = obtainStyledAttributes.getDimensionPixelSize(a.e.CardView_android_minWidth, 0);
