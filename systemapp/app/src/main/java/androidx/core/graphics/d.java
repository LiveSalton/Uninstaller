...
public class d {
    ...
    public static Typeface a(Context context, CancellationSignal cancellationSignal, b.C0021b[] c0021bArr, int i) {
        return a.a(context, cancellationSignal, c0021bArr, i);
    }
