    ...
    private static ColorStateList b(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                TypedArray a = a(resources, theme, attributeSet, a.c.ColorStateListItem);
                int color = a.getColor(a.c.ColorStateListItem_android_color, -65281);
                float f = 1.0f;
                if (a.hasValue(a.c.ColorStateListItem_android_alpha)) {
                    f = a.getFloat(a.c.ColorStateListItem_android_alpha, 1.0f);
                } else if (a.hasValue(a.c.ColorStateListItem_alpha)) {
                    f = a.getFloat(a.c.ColorStateListItem_alpha, 1.0f);
                }
                a.recycle();
                ...
                for (int i4 = 0; i4 < attributeCount; i4++) {
                    ...
                    if (attributeNameResource != 16843173 && attributeNameResource != 16843551 && attributeNameResource != a.C0016a.alpha) {
                        int i5 = i3 + 1;
