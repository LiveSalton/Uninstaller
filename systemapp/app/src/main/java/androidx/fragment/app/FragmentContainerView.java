...
public final class FragmentContainerView extends FrameLayout {
    ...
    FragmentContainerView(Context context, AttributeSet attributeSet, i iVar) {
        super(context, attributeSet);
        String str;
        this.c = true;
        ...
        Fragment c2 = iVar.y().c(context.getClassLoader(), classAttribute);
        c2.a(context, attributeSet, (Bundle) null);
        iVar.a().c(true).a(this, c2, string).c();
    }
