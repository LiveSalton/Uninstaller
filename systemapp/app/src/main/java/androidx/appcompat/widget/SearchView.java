...
public class SearchView extends LinearLayoutCompat implements androidx.appcompat.view.c {
    ...
    class AnonymousClass3 implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            if (SearchView.this.g instanceof z) {
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, a.C0001a.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i2) {
        ...
        af a2 = af.a(context, attributeSet, a.j.SearchView, i2, 0);
        ...
        androidx.core.h.w.a(this.l, a2.a(a.j.SearchView_queryBackground));
        androidx.core.h.w.a(this.m, a2.a(a.j.SearchView_submitBackground));
        ...
        ah.a(this.b, getResources().getString(a.h.abc_searchview_description_search));
    ...
    private void s() {
        ...
        if (this.h.getSuggestAuthority() != null) {
            this.g = new z(getContext(), this, this.h, this.T);
            this.a.setAdapter(this.g);
            ((z) this.g).a(this.I ? 2 : 1);
        }
    }
