...
public class a extends androidx.appcompat.b.a.d implements androidx.core.graphics.drawable.b {
    ...
    private boolean b(int i) {
        ...
        if (current instanceof AnimationDrawable) {
            c0005a = new d((AnimationDrawable) current, bVar.b(a3, a4), c2);
        } else if (current instanceof androidx.h.a.a.c) {
            c0005a = new c((androidx.h.a.a.c) current);
        } else {
            if (!(current instanceof Animatable)) {
                return false;
            }
            c0005a = new C0005a((Animatable) current);
        }
        c0005a.a();
        this.c = c0005a;
        this.e = d2;
    ...
    private static class C0005a extends f {
        private final Animatable a;

        C0005a(Animatable animatable) {
            super();
            this.a = animatable;
        }
    ...
    private static class c extends f {
        private final androidx.h.a.a.c a;
    ...
    private int d(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        Drawable a3 = resourceId3 > 0 ? v.a().a(context, resourceId3) : null;
        ...
        if (a3 == null) {
            ...
            if (xmlPullParser.getName().equals("animated-vector")) {
                a3 = androidx.h.a.a.c.a(context, resources, xmlPullParser, attributeSet, theme);
    ...
    private int e(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        Drawable a3 = resourceId2 > 0 ? v.a().a(context, resourceId2) : null;
        a2.recycle();
    ...
    static class b extends d.a {
        ...
        @Override // androidx.appcompat.b.a.d.a, androidx.appcompat.b.a.b.AbstractC0006b
        void a() {
            this.a = this.a.clone();
            this.b = this.b.clone();
        }
    ...
    void a(b.AbstractC0006b abstractC0006b) {
        ...
        if (abstractC0006b instanceof b) {
            this.b = (b) abstractC0006b;
        }
    }
