...
public final class zzbqj implements zzepf<zzbxy<zzbsm>> {
    ...
    private zzbqj(zzeps<zzcke> zzepsVar, zzeps<Executor> zzepsVar2) {
        this.a = zzepsVar;
        this.b = zzepsVar2;
    }

    public static zzbqj a(zzeps<zzcke> zzepsVar, zzeps<Executor> zzepsVar2) {
        return new zzbqj(zzepsVar, zzepsVar2);
    }
