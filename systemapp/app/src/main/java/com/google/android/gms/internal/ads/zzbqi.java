...
public final class zzbqi implements zzepf<zzbxy<zzbub>> {
    ...
    private zzbqi(zzeps<zzbul> zzepsVar, zzeps<Executor> zzepsVar2) {
        this.a = zzepsVar;
        this.b = zzepsVar2;
    }

    public static zzbqi a(zzeps<zzbul> zzepsVar, zzeps<Executor> zzepsVar2) {
        return new zzbqi(zzepsVar, zzepsVar2);
    }
