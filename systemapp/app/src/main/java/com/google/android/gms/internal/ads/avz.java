...
final class avz {
    ...
    private static final Logger b = Logger.getLogger(avz.class.getName());
    private static final Unsafe c = c();
    private static final Class<?> d = asn.b();
    ...
    static final class a extends d {
        ...
        @Override // com.google.android.gms.internal.ads.avz.d
    ...
    static Unsafe c() {
        try {
            return (Unsafe) AccessController.doPrivileged(new awb());
    ...
    private static Field f() {
        Field a2;
        if (asn.a() && (a2 = a((Class<?>) Buffer.class, "effectiveDirectAddress")) != null) {
            return a2;
        }
