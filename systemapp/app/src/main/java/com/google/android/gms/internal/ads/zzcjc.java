...
public final class zzcjc implements zzepf<zzbxy<zzbsm>> {
    ...
    private zzcjc(zzeps<zzcjj> zzepsVar, zzeps<Executor> zzepsVar2) {
        this.a = zzepsVar;
        this.b = zzepsVar2;
    }

    public static zzcjc a(zzeps<zzcjj> zzepsVar, zzeps<Executor> zzepsVar2) {
        return new zzcjc(zzepsVar, zzepsVar2);
    }
