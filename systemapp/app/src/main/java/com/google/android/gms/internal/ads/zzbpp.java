...
public final class zzbpp implements zzepf<zzbxy<zzva>> {
    ...
    private zzbpp(zzeps<zzbjv> zzepsVar, zzeps<Executor> zzepsVar2) {
        this.a = zzepsVar;
        this.b = zzepsVar2;
    }

    public static zzbpp a(zzeps<zzbjv> zzepsVar, zzeps<Executor> zzepsVar2) {
        return new zzbpp(zzepsVar, zzepsVar2);
    }
