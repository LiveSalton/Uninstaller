...
interface awo {
    ...
    <K, V> void a(int i, aug<K, V> augVar, Map<K, V> map) throws IOException;

    void a(int i, zzeiu zzeiuVar) throws IOException;

    void a(int i, Object obj) throws IOException;

    void a(int i, Object obj, avd avdVar) throws IOException;

    void a(int i, String str) throws IOException;

    void a(int i, List<String> list) throws IOException;

    void a(int i, List<?> list, avd avdVar) throws IOException;
    ...
    @Deprecated
    void b(int i, Object obj, avd avdVar) throws IOException;

    void b(int i, List<zzeiu> list) throws IOException;

    @Deprecated
    void b(int i, List<?> list, avd avdVar) throws IOException;
