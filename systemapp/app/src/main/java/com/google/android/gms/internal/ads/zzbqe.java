...
public final class zzbqe implements zzepf<zzbxy<zzbsm>> {
    ...
    private zzbqe(zzeps<zzbul> zzepsVar, zzeps<Executor> zzepsVar2) {
        this.a = zzepsVar;
        this.b = zzepsVar2;
    }

    public static zzbqe a(zzeps<zzbul> zzepsVar, zzeps<Executor> zzepsVar2) {
        return new zzbqe(zzepsVar, zzepsVar2);
    }
