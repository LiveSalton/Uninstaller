...
public final class zzcki implements zzepf<zzbxy<zzbui>> {
    ...
    private zzcki(zzeps<zzckg> zzepsVar, zzeps<Executor> zzepsVar2) {
        this.a = zzepsVar;
        this.b = zzepsVar2;
    }

    public static zzcki a(zzeps<zzckg> zzepsVar, zzeps<Executor> zzepsVar2) {
        return new zzcki(zzepsVar, zzepsVar2);
    }
