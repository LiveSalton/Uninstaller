...
final class bdx extends beh<zzxg> {
    ...
    bdx(zzvx zzvxVar, Context context, zzvn zzvnVar, String str, zzani zzaniVar) {
        this.e = zzvxVar;
        this.a = context;
        this.b = zzvnVar;
        this.c = str;
    ...
    public final /* synthetic */ zzxg b() throws RemoteException {
        zzvi zzviVar;
        zzviVar = this.e.a;
        return zzviVar.a(this.a, this.b, this.c, this.d, 1);
    }

    @Override // com.google.android.gms.internal.ads.beh
    public final /* synthetic */ zzxg a(zzxp zzxpVar) throws RemoteException {
        return zzxpVar.a(ObjectWrapper.a(this.a), this.b, this.c, this.d, 203404000);
    }
}
