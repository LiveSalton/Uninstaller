...
public final class zzbqb implements zzepf<zzbxy<zzbsi>> {
    ...
    private zzbqb(zzeps<zzbul> zzepsVar, zzeps<Executor> zzepsVar2) {
        this.a = zzepsVar;
        this.b = zzepsVar2;
    }

    public static zzbqb a(zzeps<zzbul> zzepsVar, zzeps<Executor> zzepsVar2) {
        return new zzbqb(zzepsVar, zzepsVar2);
    }
