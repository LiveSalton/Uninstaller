...
public final class zzcje implements zzepf<zzbxy<zzbtj>> {
    ...
    private zzcje(zzeps<zzcjj> zzepsVar, zzeps<Executor> zzepsVar2) {
        this.a = zzepsVar;
        this.b = zzepsVar2;
    }

    public static zzcje a(zzeps<zzcjj> zzepsVar, zzeps<Executor> zzepsVar2) {
        return new zzcje(zzepsVar, zzepsVar2);
    }
