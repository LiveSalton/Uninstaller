...
public final class zzciz implements zzepf<zzbxy<zzbrz>> {
    ...
    private zzciz(zzeps<zzcjj> zzepsVar, zzeps<Executor> zzepsVar2) {
        this.a = zzepsVar;
        this.b = zzepsVar2;
    }

    public static zzciz a(zzeps<zzcjj> zzepsVar, zzeps<Executor> zzepsVar2) {
        return new zzciz(zzepsVar, zzepsVar2);
    }
