...
public final class k {
    ...
    private static final int[] b = {a.b.colorSecondary};
    ...
    public static af b(Context context, AttributeSet attributeSet, int[] iArr, int i, int i2, int... iArr2) {
        a(context, attributeSet, i, i2);
        c(context, attributeSet, iArr, i, i2, iArr2);
        return af.a(context, attributeSet, iArr, i, i2);
    }
