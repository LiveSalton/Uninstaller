...
public final class zzbpr implements zzepf<zzbxy<zzbsi>> {
    ...
    private zzbpr(zzeps<zzbjv> zzepsVar, zzeps<Executor> zzepsVar2) {
        this.a = zzepsVar;
        this.b = zzepsVar2;
    }

    public static zzbpr a(zzeps<zzbjv> zzepsVar, zzeps<Executor> zzepsVar2) {
        return new zzbpr(zzepsVar, zzepsVar2);
    }
