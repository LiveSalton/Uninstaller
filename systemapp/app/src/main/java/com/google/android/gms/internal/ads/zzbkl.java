...
public final class zzbkl implements zzepf<Set<zzbxy<zzbsm>>> {
    ...
    private zzbkl(zzeps<zzbki> zzepsVar, zzeps<Executor> zzepsVar2, zzeps<JSONObject> zzepsVar3) {
        this.a = zzepsVar;
        this.b = zzepsVar2;
        this.c = zzepsVar3;
    }

    public static zzbkl a(zzeps<zzbki> zzepsVar, zzeps<Executor> zzepsVar2, zzeps<JSONObject> zzepsVar3) {
        return new zzbkl(zzepsVar, zzepsVar2, zzepsVar3);
    }
