...
public class h extends Dialog implements DialogInterface.OnKeyListener, View.OnClickListener {
    private static final String a = "h";
    private final Context b;
    private final com.jumobile.manager.systemapp.d.f c;

    public h(Context context, com.jumobile.manager.systemapp.d.f fVar) {
